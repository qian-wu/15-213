...
00000000004010f4 <phase_6>:
  ...
  40110b:	49 89 e6             	mov    %rsp,%r14 #rsp 0-20 input strings
  40110e:	41 bc 00 00 00 00    	mov    $0x0,%r12d # r12d i
  401114:	4c 89 ed             	mov    %r13,%rbp # r13 -> rsp = input[i]
  401117:	41 8b 45 00          	mov    0x0(%r13),%eax # eax input[i]
  40111b:	83 e8 01             	sub    $0x1,%eax 
  40111e:	83 f8 05             	cmp    $0x5,%eax # input[i] - 1 <= 5
  ...
  401138:	8b 04 84             	mov    (%rsp,%rax,4),%eax # eax = input[i+1]
  40113b:	39 45 00             	cmp    %eax,0x0(%rbp) # input[i+1] <> input[i]
  40113e:	75 05                	jne    401145 <phase_6+0x51>
  401140:	e8 f5 02 00 00       	callq  40143a <explode_bomb>
  401145:	83 c3 01             	add    $0x1,%ebx # j++
  401148:	83 fb 05             	cmp    $0x5,%ebx # j <= 5
  40114b:	7e e8                	jle    401135 <phase_6+0x41>
  40114d:	49 83 c5 04          	add    $0x4,%r13 # i + 1
  401151:	eb c1                	jmp    401114 <phase_6+0x20>

  401153:	48 8d 74 24 18       	lea    0x18(%rsp),%rsi # end stack address of input 6 numbers (stack 0 - 20)
  401158:	4c 89 f0             	mov    %r14,%rax # == rsp
  40115b:	b9 07 00 00 00       	mov    $0x7,%ecx # ecx 7
  401160:	89 ca                	mov    %ecx,%edx # edx 7
  401162:	2b 10                	sub    (%rax),%edx # 7 - input[i]
  401164:	89 10                	mov    %edx,(%rax)
  401166:	48 83 c0 04          	add    $0x4,%rax # input[i + 1]
  40116a:	48 39 f0             	cmp    %rsi,%rax # is come to last input 
  40116d:	75 f1                	jne    401160 <phase_6+0x6c>
  40116f:	be 00 00 00 00       	mov    $0x0,%esi
  401174:	eb 21                	jmp    401197 <phase_6+0xa3>

  401176:	48 8b 52 08          	mov    0x8(%rdx),%rdx #link list to next
  40117a:	83 c0 01             	add    $0x1,%eax # 2
  ...
  401197:	8b 0c 34             	mov    (%rsp,%rsi,1),%ecx # input items
  40119a:	83 f9 01             	cmp    $0x1,%ecx
  40119d:	7e e4                	jle    401183 <phase_6+0x8f>
  40119f:	b8 01 00 00 00       	mov    $0x1,%eax # 1
  4011a4:	ba d0 32 60 00       	mov    $0x6032d0,%edx # edx head of linklist
  4011a9:	eb cb                	jmp    401176 <phase_6+0x82>

  4011ab:	48 8b 5c 24 20       	mov    0x20(%rsp),%rbx # rsp + 32 head
  4011b0:	48 8d 44 24 28       	lea    0x28(%rsp),%rax # rsp + 40 tail
  4011b5:	48 8d 74 24 50       	lea    0x50(%rsp),%rsi # rsp + 80
  4011ba:	48 89 d9             	mov    %rbx,%rcx # rcx head
  4011bd:	48 8b 10             	mov    (%rax),%rdx # tail -> rdx
  4011c0:	48 89 51 08          	mov    %rdx,0x8(%rcx) # tail -> head + 8
  4011c4:	48 83 c0 08          	add    $0x8,%rax # tail + 8
  4011c8:	48 39 f0             	cmp    %rsi,%rax
  4011cb:	74 05                	je     4011d2 <phase_6+0xde>
  4011cd:	48 89 d1             	mov    %rdx,%rcx #tail
